...
ᴊᴜsᴛ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ᴏᴡɴ ɢʀᴏᴜᴘ ᴀɴᴅ ᴇɴᴊᴏʏ 😍....

ɪ ᴄᴀɴ ᴡᴏʀᴋ ɪɴ ɢʀᴏᴜᴘs ᴏɴʟʏ 😏...

ᴅᴏɴ'ᴛ ғᴏʀɢᴇᴛ ᴛᴏ ᴀᴅᴅ ᴍᴇ...</b>"""

    GSTART_TXT = """ʜᴇʏ {},\n\nɪ ᴀᴍ ᴛʜᴇ ᴍᴏꜱᴛ ᴘᴏᴡᴇʀꜰᴜʟ ᴀᴜᴛᴏ ꜰɪʟᴛᴇʀ ʙᴏᴛ ᴡɪᴛʜ ᴘʀᴇᴍɪᴜᴍ ꜰᴇᴀᴛᴜʀᴇꜱ.\n\nᴍᴀɴᴛᴀɪɴᴇᴅ ʙʏ : <a href='https://t.me/GrootMovieMax'>Ⓤ︎Ⓝ︎Ⓚ︎Ⓝ︎Ⓞ︎Ⓦ︎Ⓝ︎</a>"""
    
    HELP_TXT = """<b>ʜᴇʏ {},
    
ᴡᴇ ʜᴀᴠᴇ ᴅᴇᴠɪᴅᴇᴅ ʙᴏᴛ ᴄᴏᴍᴍᴀɴᴅꜱ ꜰᴏʀ ɢʀᴏᴜᴘ ᴏᴡɴᴇʀꜱ ᴀɴᴅ ʙᴏᴛ ᴜꜱᴇʀꜱ.</b>"""

    ABOUT_TXT = """<b>‣ ᴍʏ ɴᴀᴍᴇ : {}\n‣ ᴄʀᴇᴀᴛᴏʀ : <a href='https://t.me/GrootMovieMax'>GrootMovieMax</a>\n‣ ʟɪʙʀᴀʀʏ : ᴘʏʀᴏɢʀᴀᴍ\n‣ ʟᴀɴɢᴜᴀɢᴇ : ᴘʏᴛʜᴏɴ\n‣ ᴅᴀᴛᴀ ʙᴀsᴇ : ᴍᴏɴɢᴏ ᴅʙ\n‣ ʜᴏsᴛᴇᴅ ᴏɴ  : ʜᴇʀᴏᴋᴜ\n‣ ʙᴜɪʟᴅ sᴛᴀᴛᴜs : ᴠ4.2 [sᴛᴀʙʟᴇ]</b>"""
...
☆ ᴄʜᴇᴄᴋ ɪғ ʏᴏᴜ ʜᴀᴠᴇ ᴛʏᴘᴇᴅ ᴛʜᴇ ᴍᴏᴠɪᴇ ɴᴀᴍᴇ ᴄᴏʀʀᴇᴄᴛʟʏ?

☆ మీరు సినిమా పేరును సరిగ్గా టైప్ చేశారో లేదో చూసుకోండి?

1) ᴛʏᴘᴇ ᴏɴʟʏ ᴍᴏᴠɪᴇ ɴᴀᴍᴇ
...
2) ɪғ ʏᴏᴜ ᴡᴀɴᴛ ᴅᴠᴅ ᴍᴏᴠɪᴇs ᴀsᴋ ᴛʜᴇ ᴏᴡɴᴇʀ

3) ᴍᴏᴠɪᴇ ɪs ɴᴏᴛ ᴀᴠᴀɪʟᴀʙʟᴇ ɪɴ ᴛʜᴇ ᴅᴀᴛᴀʙᴀsᴇ ʀᴇᴘᴏʀᴛ ᴛᴏ ᴀᴅᴍɪɴs @imHamkerCat</b>"""
...
🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href='https://t.me/GrootMovieMax'>GrootMovieMax</a></b>"""
...
• /myplan - ᴄʜᴇᴄᴋ ʏᴏᴜʀ ᴄᴜʀʀᴜɴᴛ ᴘʟᴀɴ @GrootMovieMax"""
...
• /purge - ᴅᴇʟᴇᴛᴇ ᴀʟʟ ᴍᴇssᴀɢᴇs ꜰʀᴏᴍ ᴛʜᴇ ʀᴇᴘʟɪᴇᴅ ᴛᴏ ᴍᴇssᴀɢᴇ, ᴛᴏ ᴛʜᴇ ᴄᴜʀʀᴇɴᴛ ᴍᴇssᴀɢᴇ @GrootMovieMax"""
...
• /restart - <code>ʀᴇꜱᴛᴀʀᴛ ᴛʜᴇ ʙᴏᴛ.</code> @GrootMovieMax"""
...
""" 
   # PLEASE DO NOT REMOVE ANY CREDITS ❤️‍🩹
    ...
    CAPTION = """ 📂 <i><a href="https://telegram.me/GrootMovieMax">{file_name}</a></i>\n\n"""
...
DELUX MOVIE BOT WORKING PROPERLY"""
...
➛😶‍🌫️Contact for payment- <a href='https://t.me/GrootMovieMax'>GrootMovieMax</a>
...
‼️ ᴀғᴛᴇʀ sᴇɴᴅɪɴɢ ᴀ sᴄʀᴇᴇɴsʜᴏᴛ ᴘʟᴇᴀsᴇ ɢɪᴠᴇ ᴜs sᴏᴍᴇ ᴛɪᴍᴇ ᴛᴏ ᴀᴅᴅ ʏᴏᴜ ɪɴ ᴛʜᴇ ᴘʀᴇᴍɪᴜᴍ ʟɪsᴛ @GrootMovieMax</b>"""
...
👨‍💻 ᴄᴏɴᴛᴀᴄᴛ for payment <a href='https://t.me/GrootMovieMax'>GrootMovieMax</a> ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ ᴛʀɪᴀʟ.
...
🏆 ɪꜰ ʏᴏᴜ ᴡᴀɴᴛ ᴀ ɴᴇᴡ ᴘʟᴀɴ ᴀᴘᴀʀᴛ ꜰʀᴏᴍ ᴛʜᴇ ɢɪᴠᴇɴ ᴘʟᴀɴ, ᴛʜᴇɴ ʏᴏᴜ ᴄᴀɴ ᴛᴀʟᴋ ᴛᴏ ᴏᴜʀ <a href='https://t.me/GrootMovieMax'>GrootMovieMax</a> ᴅɪʀᴇᴄᴛʟʏ ʙʏ ᴄʟɪᴄᴋɪɴɢ ᴏɴ ᴛʜᴇ ᴄᴏɴᴛᴀᴄᴛ ʙᴜᴛᴛᴏɴ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ.
...
-Dev [Owner of this bot ]<a href='https://t.me/GrootMovieMax'>Ⓤ︎Ⓝ︎Ⓚ︎Ⓝ︎Ⓞ︎Ⓦ︎Ⓝ︎</a>
"""
