...
async def start(client, message):
    ...
    if len(message.command) != 2:
        ...
        if curr_time < 12:
            ...
            gtxt = "ɢᴏᴏᴅ ɴɪɢʜᴛ 👋"
        m=await message.reply_text("<i>ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ <b>ᴛʜᴇ ᴅᴇʟᴜx ᴍᴏᴠɪᴇ ʙᴏᴛ</b>.\nʜᴏᴘᴇ ʏᴏᴜ'ʀᴇ ᴅᴏɪɴɢ ᴡᴇʟʟ...</i>")
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        buttons = [[
                    ...
                    InlineKeyboardButton('✨ Gʀᴏᴜᴘ ✨', url="https://t.me/GrootMovieMax"),
                    InlineKeyboardButton('🛡️ ᴜᴘᴅᴀᴛᴇꜱ 🛡️', callback_data='channels')
                ],[
                ...
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            ...
                            [
                                InlineKeyboardButton('📌 ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇꜱ ᴄʜᴀɴɴᴇʟ 📌', url=f'https://t.me/GrootMovieMax') #Don't change anything without contacting me @GrootMovieMax
                            ]
                        ]
                    )
                )
    ...
    if data.startswith("sendfiles"):
        ...
        for file in files:
            ...
            [
             ...
             [
              InlineKeyboardButton('📌 ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇꜱ ᴄʜᴀɴɴᴇʟ 📌', url=f'https://t.me/GrootmovieMax') #Don't change anything without contacting me @LazyDeveloperr
             ]
            ]
        )
    )
    ...
    if not files_:
        ...
        try:
            ...
            k = await msg.reply("<b><u>❗️❗️❗️IMPORTANT❗️️❗️❗️</u></b>\n\nThis Movie File/Video will be deleted in <b><u>3 mins</u> 🫥 <i></b>(Due to Copyright Issues)</i>.\n\n<b><i>Please forward this File/Video to your Saved Messages and Start Download there,Join our Group More Updates @GrootMovieMax😏</i></b>",quote=True)
            await asyncio.sleep(180)
            await msg.delete()
